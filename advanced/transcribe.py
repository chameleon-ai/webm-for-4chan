...
def transcribe(input_filename : str, model='large-v3-turbo', device='cuda', language='auto', condition_on_previous_text=False):
    ...
    print('Transcribing...')
    result = whisper.transcribe_timestamped(loaded_model, audio, language=None if language == 'auto' else language, condition_on_previous_text=condition_on_previous_text)
    return result
